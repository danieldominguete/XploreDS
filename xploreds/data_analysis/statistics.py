...
def get_psi_score_from_numerical_covariables(
    expected_data: pd,
    ...
    expected_array = expected_data[expected_column_name]
    actual_array = actual_data[actual_column_name]
    ...
    if buckettype == "bins":
        ...
        log.error("buckettype not supported")
        return None
